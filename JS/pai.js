...
// 2. anchors
console.log("Nombre d'anchors:", document.anchors.length);

// 3. length (exemple amb imatges)
console.log("Nombre d'imatges:", document.images.length);

// 4. innerHTML (modificar contingut)
...
// 7. images (modificar imatge)
setTimeout(() => {
  document.images[0].src = "ciutat2.jpg";
